...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	function init() {
        ...
        // Colors
	$linkColor = new Color($gantry->get('menu_active_backgroundcolor'));
	$lessVariables = array(
		...
		'tk_body_backgroundcolor'=>$gantry->get('MainBodyFieldsSet-mainbodybackgroundcolor'),
		'tk_mainbodytextcolor'=>$gantry->get('MainBodyFieldsSet-mainbodytextcolor'),
		'tk_mainbodytextshadowcolor'=>$gantry->get('MainBodyFieldsSet-mainbodytextshadowcolor'),
		'tk_header_background_color'=>$gantry->get('HeaderFieldSet-headerBackgroundColor'),
	        'tk_copyright_background_color'=>$gantry->get('CopyrightFieldSet-copyrightBackgroundColor'),
		'tk_tkfeatures_background_color'=>$gantry->get('tkFeaturesFieldSet-tkFeaturesBackgroundColor'),
		...
		'logotext_textcolor'=>$gantry->get('textlogo-tksd_logo_textcolor'),
		'logotext_hover_textcolor'=>$gantry->get('textlogo-tksd_logo_hover_textcolor'),			     
		);
	...
	$css.= $this->buildBackground('bodyBackground-backgroundRepeat','bodyBackground-imageBG1',"body");
	...
	/*function for building backgrounds */
	function buildBackground($bgRepeat,$bgSelect,$cssSelector){
        /** @var $gantry Gantry */
		global $gantry;
        $source="";
        $backgroundRepeat = $gantry->get($bgRepeat);
	    
        $background = str_replace("&quot;", '"', str_replace("'", '"', $gantry->get($bgSelect)));
        ...
        $output = "";
        $output .= $cssSelector."{background: url(".$source.") ".$backgroundRepeat." !important }"."\n";
