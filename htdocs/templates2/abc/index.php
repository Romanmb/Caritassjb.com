...
<?php endif; ?>	
    <?php
		...
		$gantry->addStyle('animate.min.css');
		$gantry->addScript('tksd_addClasses.js');
...
<body <?php echo $gantry->displayBodyTag(); ?>>
	...
	<footer id="rt-footer-surround">
		...
		<?php /** Begin tk features **/ if ($gantry->countModules('tkfeatures')) : ?>
		<div id="tkfeatures">
			<div class="rt-container">
				<?php echo $gantry->displayModules('tkfeatures','standard','standard'); ?>
				<div class="clear"></div>
			</div>
		</div>
		<?php /** End tkFeatures **/ endif; ?>
	</footer>
