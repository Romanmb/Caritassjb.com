...
<div class="jshop">
    ...
    <div class = "jshop_register" style="padding-top:0px;">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "m_name" id = "m_name" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "firma_name" id = "firma_name" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group" id = 'tr_field_firma_code' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          ...
          <div class = "controls">
            <input type = "text" name = "firma_code" id = "firma_code" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group" id = 'tr_field_tax_number' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          ...
          <div class = "controls">
            <input type = "text" name = "tax_number" id = "tax_number" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "email2" id = "email2" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
    ...
    <div class = "jshop_register">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "home" id = "home" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "apartment" id = "apartment" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "street" id = "street" value = "" class = "input" />
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "state" id = "state" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
    ...
    <div class = "jshop_register">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "mobil_phone" id = "mobil_phone" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "fax" id = "fax" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_1" id = "ext_field_1" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_2" id = "ext_field_2" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_3" id = "ext_field_3" value = "" class = "input" />
          </div>
        </div>
        <?php endif; ?>
    </div>
