...
<div><strong><?php echo _JSHOP_PRODUCTS; ?></strong></div>
<div class = "jshop cart">
      ...
      ?>
        <?php if ($i % 3 == 0) : ?>
            <div class = "row-fluid">
        <?php endif; ?>
      <div class="jshop_prod_cart span4">
        <div class="product_name">
            ...
            <?php if (count($files)){?>
                ...
                <?php foreach($files as $file){?>
                    <div><?php print $file->file_descr?> <a class = "btn" href="<?php print JURI::root()?>index.php?option=com_jshopping&controller=product&task=getfile&oid=<?php print $this->order->order_id?>&id=<?php print $file->id?>&hash=<?php print $this->order->file_hash;?>"><?php print _JSHOP_DOWNLOAD?></a></div>
                <?php }?>
             <?php }?>        
        </div>
        <?php if ($this->config->show_product_code_in_order) : ?>
            <div>
                <?php print _JSHOP_EAN_PRODUCT.': '.$prod->product_ean; ?>
            </div>
        <?php endif; ?>
        <div>
        ...
        <div>
            <?php print _JSHOP_NUMBER . ': ' . formatqty($prod->product_quantity);?><?php print $prod->_qty_unit;?>
        </div>
        <div>
    ...
    <?php if ($this->allow_cancel){?>
        <a href="<?php print SEFLink('index.php?option=com_jshopping&controller=user&task=cancelorder&order_id='.$order->order_id)?>" class = "btn"><?php print _JSHOP_CANCEL_ORDER?></a>
    <?php }?>
</div>