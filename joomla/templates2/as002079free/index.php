...
<head>
	...
	<?php
		...
		$menu_id = 0;
		if (JRequest::getVar('view') != ('form' || 'login'))
		{
...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body__" . $pageClass;?>">
    ...
    <div class="wrapper">
		...
		<?php if ($this->countModules('as-position-slider')): ?>
        <div class="header">
            <div id="slider-row">                
                <div class="row">
                    <jdoc:include type="modules" name="as-position-slider" style="themeHtml5" />
                </div>
            </div>
        </div>
		<?php endif; ?>
    ...
    <div id="footer">
        ...
        <?php endif; ?>
            ...
            <?php if ($this->countModules('as-position-map')): ?>
            <div id="map">
                <jdoc:include type="modules" name="as-position-map" style="themeHtml5" />
            </div>
            <?php endif; ?> 
